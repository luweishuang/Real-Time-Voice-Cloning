...
if __name__ == '__main__':
    ...
    parser.add_argument("-e", "--enc_model_fpath", type=Path, 
                        default="pretrained_offical/encoder/saved_models/pretrained.pt",
                        help="Path to a saved encoder")
    parser.add_argument("-s", "--syn_model_dir", type=Path, 
                        default="pretrained_offical/synthesizer/saved_models/logs-pretrained/",
                        help="Directory containing the synthesizer model")
    parser.add_argument("-v", "--voc_model_fpath", type=Path, 
                        default="pretrained_offical/vocoder/saved_models/pretrained/pretrained.pt",
